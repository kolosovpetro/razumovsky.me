...
export class OeisComponent {
  topics: OeisTopic[] = [
    ...
    new OeisTopic("Edited", [
      ...
      new OeisLink("A002457", "https://oeis.org/A002457", " — Sequence defined by a(n) = (2n+1)!/n!^2"),
      ...
      new OeisLink("A001093", "https://oeis.org/A001093", " — Sequence defined by a(n) = n^3 + 1"),
      ...
      new OeisLink("A227776", "https://oeis.org/A227776", " — Sequence defined by a(n) = 6*n^2 + 1"),
      new OeisLink("A258806", "https://oeis.org/A258806", " — Sequence defined by a(n) = n^7 + 1"),
      new OeisLink("A275709", "https://oeis.org/A275709", " — Sequence defined by a(n) = 2*n^3 + 3*n^2"),
    ])
  ];
}
