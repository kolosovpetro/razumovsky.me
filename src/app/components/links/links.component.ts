...
export class LinksComponent {
  links: LinksItem[] = [
    new LinksItem("Academia Algebrae", "../pdf/faulhaber_academia_algebrae.pdf", "by Johann Faulhaber, 1631"),
    new LinksItem("Cheat Sheet", "../pdf/cs_cheat_sheet.pdf", "on Theoretical Computer Science"),
    ...
    new LinksItem("Sums of powers of positive integers and their recurrence relations", "../pdf/Sums_of_powers_of_positive_integers_and_their_recurrence_relations.pdf", ""),
    new LinksItem("J. L. Gross, Combinatorial Methods with Computer Applications, 2008. [Chapter 4]", "../pdf/CM4.pdf", ""),
